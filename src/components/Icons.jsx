// Íconos SVG (estilo lucide, stroke). Tamaño por prop size.
const base = (size = 20) => ({
  width: size,
  height: size,
  viewBox: "0 0 24 24",
...
export const Chat = ({ size }) => (
  <svg {...base(size)}>
    <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2Z" />
  </svg>
);
export const Sparkles = ({ size }) => (
  <svg {...base(size)}>
...
export const Brain = ({ size }) => (
  <svg {...base(size)}>
    <path d="M12 5a3 3 0 0 0-5.9-.6A3 3 0 0 0 3 7.5a3 3 0 0 0 .8 5A2.5 2.5 0 0 0 6 16.5a3 3 0 0 0 6 .5Z" />
